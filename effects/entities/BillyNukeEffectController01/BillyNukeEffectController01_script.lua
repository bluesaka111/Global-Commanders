...
BillyNukeEffectController01 = Class(NullShell) {
    ...
    EffectThread = function(self)
        ...
        CreateLightParticle(self, -1, army, 18, 4, 'glow_02', 'ramp_red_02')
        ...
        CreateDecal(position, orientation, 'Crater01_albedo', '', 'Albedo', 27, 27, 1200, 0, army)
        CreateDecal(position, orientation, 'Crater01_normals', '', 'Normals', 27, 27, 1200, 0, army)       
        CreateDecal(position, orientation, 'nuke_scorch_003_albedo', '', 'Albedo', 32, 32, 1200, 0, army)   
    ...
    local inner_lower_limit = 2
        local outer_lower_limit = 1.2
        local outer_upper_limit = 1.2
    
    local inner_lower_height = 0.55
    local inner_upper_height = 1.55
    local outer_lower_height = 1.2
    local outer_upper_height = 1.55
...
TypeClass = BillyNukeEffectController01
